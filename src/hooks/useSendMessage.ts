...
export default function useSendMessage() {
  ...
  const updateFrequentContacts = () => {
    ...
    try {
      ...
      myFrequentContacts = totalFrequentContacts[userStore.storeSelfInfo.userID] ?? []
    } catch (error) {}
    ...
    localStorage.setItem('IMFrequentContacts_H5', JSON.stringify(totalFrequentContacts))
  }
