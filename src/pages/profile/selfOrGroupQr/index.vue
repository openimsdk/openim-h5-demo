<template>
  <div class="page_container">
    ...
    <div
      class="mx-6 mt-14 flex flex-col items-center rounded-md bg-white px-9 pt-9 pb-20 shadow-md"
    >
      ...
      <div
        class="flex h-[180px] w-[180px] items-center justify-center border-4 border-solid border-[#E8EAEF]"
      >
...
const showName = computed(() =>
  props.isGroup
    ? conversationStore.storeCurrentGroupInfo.groupName
    : userStore.storeSelfInfo.nickname,
)
const faceURL = computed(() =>
  props.isGroup
    ? conversationStore.storeCurrentGroupInfo.faceURL
    : userStore.storeSelfInfo.faceURL,
)

const title = props.isGroup ? t('groupQrCode') : t('qrCode')
const tip = props.isGroup
  ? t('messageTip.scanGroupQrCodeTip')
