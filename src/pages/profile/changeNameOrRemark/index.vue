  ...
  <div class="page_container !bg-white">
    ...
    <div class="mx-6 mt-10">
      <div class="border border-gap-text rounded-lg ">
        <van-field class="!py-1" v-model="value" :maxlength="16" label="" :placeholder="$t('placeholder.pleaseInput')"></van-field>
      </div>
    </div>
  </div>
</template>
...
const saveChange = () => {
  ...
  func.then(() => feedbackToast({ message: t("messageTip.nomalSuccess"), onClose: router.back }))
