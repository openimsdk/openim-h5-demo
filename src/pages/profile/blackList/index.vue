<template>
    <div class="page_container">
        ...
        <virtual-list v-if="contactStore.storeBlackList.length>0"
            class="my_scrollbar flex-1 overflow-y-auto bg-white mt-3" :data-key="'userID'"
            :data-sources="contactStore.storeBlackList" :data-component="GenericListItem" :estimate-size="88"
            :extra-props="{
