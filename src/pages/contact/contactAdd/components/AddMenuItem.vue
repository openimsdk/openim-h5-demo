<template>
    <div class="flex items-center px-[22px] h-[68px] bg-white">
        <slot>
            <img width="30" :src="icon" alt="" />
        </slot>
        <div class="flex-1 flex items-center justify-between ml-5 h-full border-b border-[#F1F1F1]" :class="{'!border-0':!border}" >
            <div>
