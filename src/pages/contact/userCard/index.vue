  ...
  <div class="page_container !overflow-y-auto">
    ...
    <div class="flex-1">
      ...
      <div class="mb-2" v-if="contactStore.storeUserCardData.groupMemberInfo">
        <CardDescItem
          :lable="$t('groupNickDesc')"
          :content="contactStore.storeUserCardData.groupMemberInfo.nickname"
        />
...
const cannAddFriend = computed(() => {
  ...
  if (!!contactStore.storeUserCardData.groupMemberInfo) {
    return (
      conversationStore.storeCurrentGroupInfo.applyMemberFriend === AllowType.Allowed
    )
  }
